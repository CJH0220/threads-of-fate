...
> ⚠️ **过时草稿（2026-06 早期），仅供设计思路参考，请勿据此实现**
>
> - 本文中的 NPC 命名（陈芳华 / 老汪 / 阿海 / 神秘人）为早期占位，与定稿 14 NPC 不一致
> - 时间轴仅覆盖 W1-W4（28 天），与定稿的 9 周 / 60 天不一致
> - 权威文档：
>   - 事件系统机制：`design/system/事件系统.md` + `design/system/事件结果扩展规则.md`
>   - 事件内容与节奏：`design/content/周阶段剧情.md`
>   - 事件数据：`design/data/事件配置表.csv` + `design/data/事件结果表.csv`
> - 若需重写本文档，请先与主策划案 §13 及 `content/周阶段剧情.md` 对齐后再动笔
>
> — 2026-07-14 v1.9 同步补充
